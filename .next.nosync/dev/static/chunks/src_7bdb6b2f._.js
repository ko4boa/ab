...
;
const db = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dexie$2f$import$2d$wrapper$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]('InventoryLiteDB');
...
"[project]/src/components/inventory/receive-form.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ReceiveForm({ onSuccess }) {
    ...
    const [supplierId, setSupplierId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("DEFAULT"); // default supplier for now
    ...
    const products = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dexie$2d$react$2d$hooks$2f$dist$2f$dexie$2d$react$2d$hooks$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLiveQuery"])({
        "ReceiveForm.useLiveQuery": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].products.toArray()
    }["ReceiveForm.useLiveQuery"]) || [];
    const addLine = ()=>{
        setLines([
            ...lines,
            {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            // Create PO
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].purchaseOrders.add({
                poId,
                receivedDate,
                supplierId,
                invoiceNumber,
            ...
            await Promise.all(validLines.map(async (line)=>{
                // Add Line
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].purchaseOrderLines.add({
                ...
                const currentBal = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].inventoryBalances.get(line.productId);
                if (currentBal) {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].inventoryBalances.update(line.productId, {
...
_s(ReceiveForm, "+LtrW6ie/xUE9aSctNaHF5hlBYs=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$inventory$2f$receive$2d$form$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/inventory/receive-form.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function InventoryPage() {
    ...
    const inventory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dexie$2d$react$2d$hooks$2f$dist$2f$dexie$2d$react$2d$hooks$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLiveQuery"])({
        "InventoryPage.useLiveQuery[inventory]": async ()=>{
            const balances = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].inventoryBalances.toArray();
            // Join with products
            const joined = await Promise.all(balances.map({
                "InventoryPage.useLiveQuery[inventory]": async (b)=>{
                    const product = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].products.get(b.productId);
                    return {
                        ...b,
            ...
            return joined.sort({
                "InventoryPage.useLiveQuery[inventory]": (a, b)=>a.productName.localeCompare(b.productName)
            }["InventoryPage.useLiveQuery[inventory]"]);
        }
    }["InventoryPage.useLiveQuery[inventory]"]);
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogContent"], {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$inventory$2f$receive$2d$form$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ReceiveForm"], {
...
_s(InventoryPage, "aRmrPXhlea9Wns0dHu/spnGDLZ8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dexie$2d$react$2d$hooks$2f$dist$2f$dexie$2d$react$2d$hooks$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLiveQuery"]
    ];
});
...
//# sourceMappingURL=src_7bdb6b2f._.js.map